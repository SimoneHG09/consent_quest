    ...
    <div className="startScreenContainer">
      ...
      <div className="textContainer">
        <p className="text"> 
          ...
          <p> This particular game simulates scenarios within a dating app environment. As you make decisions, try to adopt the mindset of someone using such an app. You get 3 tries, so after one serious attampt, feel free to experiment! </p> 
          <p> Throughout the game, we ask that you think aloud by verbalizing your thoughts, choices, and reactions. For example, you might explain why you selected a certain option or comment on aspects of the game's design and content. This can happen in English or German. </p> 
